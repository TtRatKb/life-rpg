const CACHE_NAME = "life-rpg-v0314dn-coloring-collection";
...
const CORE = [
  ...
  "./creative-hub-v314dl.js?v=0.31.4dn",
  ...
  "./talent-tree-v2-graph.js?v=0.31.4dn",
  ...
  "./coloring-studio.html?v=0.31.4dn",
  "./coloring-studio.html?embedded=1&v=0.31.4dn",
  "./coloring-studio.css?v=0.31.4dn",
  "./coloring-studio.js?v=0.31.4dn",
