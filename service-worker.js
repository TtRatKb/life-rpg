const CACHE_NAME = "life-rpg-v0314ba-relationship-life-2";
const CORE = [
  "./",
  "./index.html",
  ...
  "./story-engine.js?v=0.31.4ba",
  "./story-ui.js?v=0.31.4ba",
  "./relationship-memory.js?v=0.31.4ba",
  "./relationship-memory.css?v=0.31.4ba",
  "./relationship-engine.js?v=0.31.4ba",
  "./gifts.js?v=0.31.4ba",
  "./seasons.js?v=0.31.4ba",
  "./content/SP_003.dat?v=0.31.4ba",
  "./shop.js?v=0.30.6",
