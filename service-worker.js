const CACHE_NAME = "life-rpg-v0314bt-shell";
...
const CORE = [
  ...
  "./pwa.js?v=0.31.4bt",
  "./visual-performance.js?v=0.31.4bt",
  ...
  "./story-engine.js?v=0.31.4bt",
  "./story-ui.js?v=0.31.4bt",
