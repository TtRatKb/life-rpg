const CACHE_NAME = "life-rpg-v0314bs-shell";
...
const CORE = [
  ...
  "./pwa.js?v=0.31.4bs",
  "./visual-performance.js?v=0.31.4bs",
  ...
  "./story-engine.js?v=0.31.4bs",
  "./story-ui.js?v=0.31.4bs",
