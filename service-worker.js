const CACHE_NAME = "life-rpg-v0314dp-kirishima-cards";
...
const CORE = [
  ...
  "./creative-hub-v314dl.js?v=0.31.4dp",
  ...
  "./daily-life-v314cv.js?v=0.31.4cz",
  ...
  "./skills.js?v=0.31.4dk",
  "./talent-v2.js?v=0.31.4bz",
  "./talent-tree-v2-graph.js?v=0.31.4dp",
  "./talent-reward-studios.css?v=0.31.4cw",
  "./talent-v3-experiences.css?v=0.31.4cz",
  ...
  "./coloring-studio.html?v=0.31.4dp",
  "./coloring-studio.html?embedded=1&v=0.31.4dp",
  "./coloring-studio.css?v=0.31.4dn",
  "./coloring-studio.js?v=0.31.4dp",
  "./assets/coloring/kirishima-hero-grin-line.png?v=0.31.4dp",
  "./assets/coloring/kirishima-sunshine-break-line.png?v=0.31.4dp",
  "./assets/coloring/kirishima-training-glow-line.png?v=0.31.4dp",
  "./assets/coloring/kirishima-red-riot-edge-line.png?v=0.31.4dp",
  "./assets/coloring/kirishima-casual-charm-line.png?v=0.31.4dp",
  "./assets/coloring/kirishima-chair-sideways-line.png?v=0.31.4dp",
  "./assets/coloring/kirishima-stretch-break-line.png?v=0.31.4dp",
  "./assets/coloring/kirishima-come-at-me-line.png?v=0.31.4dp",
  "./assets/coloring/kirishima-lean-in-line.png?v=0.31.4dp",
  "./drawing-studio.html?v=0.31.4dl",
  "./drawing-studio.html?embedded=1&v=0.31.4dl",
  "./drawing-studio.css?v=0.31.4cp",
  "./drawing-studio.js?v=0.31.4dl",
  "./drawing-reference-workspace-v2.css?v=0.31.4cp",
  "./drawing-reference-packs-v3.js?v=0.31.4cp",
  "./drawing-reference-workspace-v2.js?v=0.31.4cp",
  ...
  "./assets/drawing/references/dynamic-turn-back.svg",
  "./assets/drawing/references/dynamic-twist-turn.svg",
  "./assets/drawing/references/hair-fall-forward.svg",
  "./assets/drawing/references/hair-flow-turn.svg",
  "./assets/drawing/references/hair-spin-back.svg",
  "./assets/drawing/references/hair-wind-side.svg",
  "./assets/drawing/references/hand-fist-construction.svg",
  "./assets/drawing/references/hand-foreshortened-palm.svg",
  "./assets/drawing/references/hand-mug-grip.svg",
  "./assets/drawing/references/hand-open-construction.svg",
  "./assets/drawing/references/hand-phone-grip.svg",
  "./assets/drawing/references/hand-pointing-construction.svg",
  "./assets/drawing/references/hand-sleeve-pinch.svg",
  "./assets/drawing/references/head-front-construction.svg",
  "./assets/drawing/references/head-looking-down.svg",
  "./assets/drawing/references/head-looking-up.svg",
  "./assets/drawing/references/head-profile-construction.svg",
  "./assets/drawing/references/head-turn-three-quarter.svg",
  "./assets/drawing/references/mood-cozy.svg",
  "./assets/drawing/references/mood-melancholic.svg",
  "./assets/drawing/references/mood-tense.svg",
  "./assets/drawing/references/perspective-bedroom-corner.svg",
  "./assets/drawing/references/perspective-cafe-booth.svg",
  "./assets/drawing/references/perspective-character-scale.svg",
  "./assets/drawing/references/perspective-hallway.svg",
  "./assets/drawing/references/perspective-low-angle-room.svg",
  "./assets/drawing/references/perspective-one-point-room.svg",
  "./assets/drawing/references/perspective-two-point-street.svg",
  "./assets/drawing/references/rendering-backlight-bust.svg",
  "./assets/drawing/references/rendering-limited-palette.svg",
  "./assets/drawing/references/rendering-side-light-bust.svg",
  "./assets/drawing/references/rendering-three-value-head.svg",
  "./assets/drawing/references/rendering-warm-cool-bust.svg",
  "./assets/drawing/references/story-argument-aisle.svg",
  "./assets/drawing/references/story-catch-fall.svg",
  "./assets/drawing/references/story-door-surprise.svg",
  "./assets/drawing/references/story-letter-discovery.svg",
