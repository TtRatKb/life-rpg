...
,
  ...
  const COLORING_PAGES = [
    { id: "bakugo-trading-card", title: "Bakugo Trading Card", subtitle: "Collectible-card coloring page · spoiler-free bonus art", src: "assets/coloring/bakugo-trading-card-line.png?v=0.31.4dn" }
  ];
